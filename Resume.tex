...
\begin{ressection}{Skills}
  ...
  \begin{reslist}{Operating Systems:}
    \ressubitem{Linux, Mac OS X, Windows desktop and server}
  \end{reslist}
  \begin{reslist}{Computer Languages:}
    \ressubitem{Javascript, HTML, CSS, Java, Ruby, Clojure, Python, C, C++, Perl, Bash,  SQL, \LaTeX, Rust}
  \end{reslist}
  \begin{reslist}{Tools, Systems, Frameworks}
    \ressubitem{WebGL and OpenGL,  Node.js, jQuery, Ruby on Rails, Sinatra, Git, Amazon AWS, Apache, Nginx, MySQL, PostgreSQL, Spring, Tomcat, Netty, 0Auth 2.0, OpenID, BIND, Active Directory}
  \end{reslist}
\end{ressection}
%%%%%%%%%%%%%%%%%%%%%%%%
