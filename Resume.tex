...
\pagestyle{empty}
\geometry{letterpaper,tmargin=.3in,bmargin=1in,lmargin=1in,rmargin=1in,headheight=0in,headsep=0in,footskip=.3in}
...
\begin{ressection}{Education}
  \begin{ressubsec}{Florida State University}{Tallahassee, Fl}{BSc. Pure Mathematics (Minor: Business)}{August 2009}
  \end{ressubsec}
\end{ressection}
